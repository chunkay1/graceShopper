...
import { AdminUser } from '../api/userRequests';
...
const AdminProducts = async ({token,category,setCategory,products,setProducts,itemProps,setItemProps,singleProduct,setSingleProduct }) => {
